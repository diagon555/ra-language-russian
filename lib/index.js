...
var russianMessages = {
    ra: {
        ...
        message: {
            ...
            bulk_update_content: "Вы уверены, что хотите обновить %{name}? |||| Вы уверены, что хотите обновить %{smart_count} записей?",
            bulk_update_title: "Обновление %{name} |||| Обновление %{smart_count} %{name}",
...
exports.default = russianMessages;
